...
namespace AinAlAtaaFoundation.Data.Migrations
{
    ...
    [Migration("20240722100602_FeaturedPointAddDistrictId")]
    partial class FeaturedPointAddDistrictId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AinAlAtaaFoundation.Models.DistrictRepresentative", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 7, 22, 13, 6, 2, 487, DateTimeKind.Local).AddTicks(8372))
                        .HasColumnName("created_at");
