...
namespace AinAlAtaaFoundation.Data.Migrations
{
    ...
    [Migration("20250107143147_AddAssociationRepresentativesTable")]
    partial class AddAssociationRepresentativesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AinAlAtaaFoundation.Models.AssociationRepresentative", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_association_representatives");

                    b.ToTable("association_representatives", (string)null);
                });
            ...
            modelBuilder.Entity("AinAlAtaaFoundation.Models.Branch", b =>
                {
                    ...
                    b.HasIndex("ClanId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ix_branches_clan_id_name");
            ...
            modelBuilder.Entity("AinAlAtaaFoundation.Models.BranchRepresentative", b =>
                {
                    ...
                    b.HasIndex("ClanId")
                        .HasDatabaseName("ix_branch_representatives_clan_id");
            ...
            modelBuilder.Entity("AinAlAtaaFoundation.Models.DatabaseInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("AinAlAtaaFoundation.Models.Disbursement", b =>
                {
                    ...
                    b.HasIndex("FamilyId")
                        .HasDatabaseName("ix_disbursements_family_id");
            ...
            modelBuilder.Entity("AinAlAtaaFoundation.Models.Family", b =>
                {
                    ...
                    b.Property<int?>("AssociationRepresentativeId")
                        .HasColumnType("INTEGER")
                        .HasColumnName("association_representative_id");
                    ...
                    b.Property<string>("RationCardOwnerName")
                        .IsRequired()
                        .HasColumnType("VARCHAR(50)")
                        .HasColumnName("ration_card_owner_name");
                    ...
                    b.HasIndex("AssociationRepresentativeId")
                        .HasDatabaseName("ix_families_association_representative_id");
            ...
            modelBuilder.Entity("AinAlAtaaFoundation.Models.FamilyMember", b =>
                {
                    ...
                    b.Property<bool>("IsDeserves")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(true)
                        .HasColumnName("is_deserves");
                    ...
                    b.HasIndex("GenderId")
                        .HasDatabaseName("ix_family_members_gender_id");

                    b.HasIndex("MotherId")
                        .HasDatabaseName("ix_family_members_mother_id");
            ...
            modelBuilder.Entity("AinAlAtaaFoundation.Models.Gender", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("FamilyPhone", b =>
                {
                    b.Property<int>("FamilyId")
                        .HasColumnType("INTEGER")
                        .HasColumnName("family_id");
                    ...
                    b.HasKey("FamilyId", "PhonesId")
                        .HasName("pk_family_phone");

                    b.HasIndex("PhonesId")
                        .HasDatabaseName("ix_family_phone_phones_id");

                    b.ToTable("family_phone", (string)null);
                });
            ...
            modelBuilder.Entity("AinAlAtaaFoundation.Models.BranchRepresentative", b =>
                {
                    ...
                    b.HasOne("AinAlAtaaFoundation.Models.Clan", "Clan")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_branch_representatives_clans_clan_id");
            ...
            modelBuilder.Entity("AinAlAtaaFoundation.Models.Disbursement", b =>
                {
                    b.HasOne("AinAlAtaaFoundation.Models.Family", "Family")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_disbursements_families_family_id");
            ...
            modelBuilder.Entity("AinAlAtaaFoundation.Models.Family", b =>
                {
                    ...
                    b.HasOne("AinAlAtaaFoundation.Models.AssociationRepresentative", "AssociationRepresentative")
                        .WithMany()
                        .HasForeignKey("AssociationRepresentativeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_families_association_representatives_association_representative_id");
                    ...
                    b.Navigation("AssociationRepresentative");
            ...
            modelBuilder.Entity("AinAlAtaaFoundation.Models.FamilyMember", b =>
                {
                    ...
                    b.HasOne("AinAlAtaaFoundation.Models.Gender", "Gender")
                        .WithMany()
                        .HasForeignKey("GenderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_family_members_genders_gender_id");

                    b.HasOne("AinAlAtaaFoundation.Models.FamilyMember", "Mother")
                        .WithMany()
                        .HasForeignKey("MotherId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_family_members_family_members_mother_id");
            ...
            modelBuilder.Entity("FamilyPhone", b =>
                {
                    b.HasOne("AinAlAtaaFoundation.Models.Family", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_family_phone_families_family_id");
                    ...
                    b.HasOne("AinAlAtaaFoundation.Models.Phone", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_family_phone_phone_phones_id");
                });
