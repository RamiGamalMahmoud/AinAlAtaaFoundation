...
namespace AinAlAtaaFoundation.Data.Migrations
{
    ...
    [Migration("20240721214234_BranchRepresentativeAddIsActiveAndDateColumn")]
    partial class BranchRepresentativeAddIsActiveAndDateColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AinAlAtaaFoundation.Models.DistrictRepresentative", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2024, 7, 22, 0, 42, 34, 179, DateTimeKind.Local).AddTicks(6865))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("AinAlAtaaFoundation.Models.Address", b =>
                {
                    ...
                    b.HasOne("AinAlAtaaFoundation.Models.FeaturedPoint", "FeaturedPoint")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_addresses_featured_point_featured_point_id");
            ...
            modelBuilder.Entity("AinAlAtaaFoundation.Models.DistrictRepresentative", b =>
                {
                    b.HasOne("AinAlAtaaFoundation.Models.Address", "Address")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_district_representatives_address_address_id");
